...
export const TOOLS: Record<string, ToolDef> = {
  ...
  '/pdf-to-word': {
    href: '/pdf-to-word',
    label: 'PDF to Word',
    desc: 'Extract text from any PDF and download as an editable .docx — no upload, no OCR needed.',
  ...
  '/word-to-pdf': {
    href: '/word-to-pdf',
    label: 'Word to PDF',
    desc: 'Convert .docx Word documents to PDF entirely in your browser — no upload.',
