      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            ImagePDF.Tools was built on a single principle: <strong className="text-slate-800 dark:text-slate-200">your images never leave your device</strong>.
        ...
        <div className="space-y-10 text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              <strong className="text-slate-800 dark:text-slate-200">File API</strong>. The file is passed to compression
          ...
          <section>
            ...
            <div className="mt-5 space-y-4">
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">JPEG — DCT + chroma subsampling</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Your image is encoded using the{' '}
                  <strong className="text-slate-800 dark:text-slate-200">MozJPEG</strong> codec (compiled to WebAssembly),
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">PNG — Median-cut palette + dithering</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  PNG files are quantised to a reduced colour palette using a{' '}
                  <strong className="text-slate-800 dark:text-slate-200">median-cut algorithm</strong> — the same technique
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">WebP — VP8 predictive coding</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  WebP is encoded using Google&apos;s{' '}
                  <strong className="text-slate-800 dark:text-slate-200">libwebp</strong> (via WebAssembly), the reference
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">SVG — Metadata strip + coordinate rounding</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  SVG files contain no pixel data — they are XML documents describing shapes. ImagePDF.Tools
                  parses the XML and removes invisible bloat: <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">&lt;metadata&gt;</code>,{' '}
                  <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">&lt;title&gt;</code>,{' '}
                  <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">&lt;desc&gt;</code> tags
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">Crop Image — Canvas API, no upload</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  The crop tool draws your image onto an HTML{' '}
                  <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">&lt;canvas&gt;</code>{' '}
                  element and then reads only the selected region using{' '}
                  <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">getImageData</code>.
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-slate-50 mb-1">EXIF Metadata — read and strip locally</h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
          ...
          <section>
            ...
            <div className="overflow-hidden border border-slate-200 dark:border-slate-600 rounded-xl">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-slate-100 dark:bg-slate-700/60 border-b border-slate-200 dark:border-slate-600">
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-slate-700 dark:text-slate-300">Where it lives</th>
                    <th className="text-left py-3 px-4 font-semibold text-slate-700 dark:text-slate-300">Sent to server?</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Your images</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Browser memory only</td>
                    <td className="py-3 px-4 text-green-700 dark:text-green-400 font-medium">Never</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Compressed output</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Browser memory (Blob URL)</td>
                    <td className="py-3 px-4 text-green-700 dark:text-green-400 font-medium">Never</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Cropped output</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Browser memory (Canvas)</td>
                    <td className="py-3 px-4 text-green-700 dark:text-green-400 font-medium">Never</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">EXIF metadata read</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Browser memory only</td>
                    <td className="py-3 px-4 text-green-700 dark:text-green-400 font-medium">Never</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Account email</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Clerk (auth provider)</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Yes — for login only</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Subscription status</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Clerk user metadata</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Yes — free or pro flag</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Payment details</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Stripe (never touches our servers)</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Stripe only</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Page visits</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Plausible Analytics (no cookies)</td>
                    <td className="py-3 px-4 text-slate-600 dark:text-slate-400">Anonymised only</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            ...
            <p>
              ...
              <strong className="text-slate-800 dark:text-slate-200">WebAssembly (WASM)</strong> modules — binary files
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside text-sm">
              ...
              <li>Open DevTools ? Sources ? look for <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">jSquashEncode.ts</code> and <code className="font-mono text-xs bg-slate-100 dark:bg-slate-700 dark:text-slate-300 px-1 rounded">pngQuantize.ts</code> to see the compression code.</li>
          ...
          {/* Last updated */}
          <p className="text-xs text-slate-500 dark:text-slate-400 border-t border-slate-200 dark:border-slate-700 pt-6">
