...
export const POSTS: Post[] = [
  // ─── PRIVACY PILLAR ──────────────────────────────────────────────────────────
  {
    ...
    title: 'How to Check If an Online File Converter Is Safe',
    description: "Not all online file converters handle your data the same way. Here's what to look for — and how to verify a tool is actually processing files in your browser.",
    date: '2025-11-04',
    category: 'privacy',
    readingTime: 5,
...
// The size saving is negligible; the quality loss is not.` },
  ...
  },
  {
    ...
    title: 'What to Look for in a Private Image Compression Tool',
    description: 'A practical checklist for evaluating whether an online image tool is genuinely private — covering client-side processing, network requests, and data retention policies.',
    date: '2026-05-02',
    category: 'privacy',
    readingTime: 5,
    relatedTool: { label: 'Remove Image Metadata', href: '/remove-metadata' },
...
performance.getEntriesByType('resource')
  ...
  // ─── NEW POSTS ───────────────────────────────────────────────────────────────
  {
    ...
    title: 'How to Crop Images Online in 5 Easy Steps',
    description: 'Cropping removes distracting edges, tightens composition, and resizes to exact aspect ratios — all in your browser, nothing uploaded.',
    date: '2026-05-05',
    category: 'productivity',
    readingTime: 4,
    ...
    body: [
      ...
      { type: 'ol', items: [
        'Go to <a href="/crop-image" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/crop-image</a>',
        'Click <strong>Choose Image</strong> or drag your file onto the page. JPEG, PNG, and WebP are all supported.',
        'Drag the crop handles on the corners and edges to select the area you want to keep.',
        'To lock a specific aspect ratio — 1:1 for Instagram, 16:9 for video — select the ratio from the presets above the canvas.',
        'Click <strong>Crop & Download</strong>. The cropped image downloads instantly to your device.',
      ]},
      { type: 'callout', kind: 'tip', text: 'Hold shift while dragging to constrain the crop to a square — useful for profile photos and thumbnails that need to be perfectly square.' },
      { type: 'h2', text: 'Which Aspect Ratio Should You Use?' },
      { type: 'table', headers: ['Platform', 'Recommended ratio', 'Pixel dimensions'], rows: [
      ...
      { type: 'h2', text: 'Freeform vs. Fixed Aspect Ratio Cropping' },
      { type: 'p', html: '<strong>Freeform cropping</strong> lets you drag handles independently — useful when you want to remove a specific object or awkward edge without worrying about exact dimensions. <strong>Fixed aspect ratio</strong> locks the proportions so the crop moves as a unit — essential for platform-specific exports where the dimensions are non-negotiable.' },
      { type: 'h2', text: 'Does Cropping Reduce File Size?' },
      { type: 'p', html: 'Yes. Cropping removes pixels, and fewer pixels means a smaller file. A 5000×4000 photo cropped to 2500×2500 will typically be 30–60% smaller depending on format and content. If file size matters, crop first, then compress. The combination of cropping and compression can cut a large photo down to a fraction of its original size without visible quality loss.' },
      { type: 'p', html: 'After cropping, run the image through the <a href="/compress-image" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">image compressor</a> for the best results. Both tools work entirely in your browser — no uploads, no sign-in required.' },
    ],
  },
  {
    slug: 'how-to-batch-resize-images',
    title: 'How to Batch Resize Images Without Installing Software',
    description: 'Resizing a folder of images to consistent dimensions saves storage, speeds up uploads, and keeps your CMS tidy — here\'s how to do it in your browser.',
    date: '2026-05-05',
    category: 'productivity',
    readingTime: 4,
    relatedTool: { label: 'Resize Image', href: '/resize-image' },
    body: [
      ...
      { type: 'ul', items: [
        '<strong>Exact pixels:</strong> Set a specific width and height. You can lock the aspect ratio (recommended) or stretch to fill the target dimensions.',
        '<strong>Percentage:</strong> Scale down proportionally — "50%" halves both dimensions and reduces file size by approximately 75%.',
        '<strong>Social media preset:</strong> Choose a platform and post type; the tool fills in the correct dimensions automatically.',
      ]},
      { type: 'h2', text: 'How to Resize an Image Online' },
      { type: 'ol', items: [
        'Open <a href="/resize-image" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/resize-image</a>',
        'Drop your image onto the page',
        'Choose <strong>By Size</strong>, <strong>Percentage</strong>, or <strong>Social Media</strong> tab',
        'Enter the target dimensions or pick a preset',
        'Click <strong>Resize & Download</strong>',
      ]},
      { type: 'callout', kind: 'tip', text: 'Enable "Do not enlarge" to prevent upscaling — resizing a small image to a larger size adds no detail and makes files bigger. The option is especially useful when processing batches of mixed-size images.' },
      { type: 'h2', text: 'What Size Should I Resize To?' },
      { type: 'p', html: 'It depends entirely on where the image is going. General guidelines:' },
      { type: 'ul', items: [
        '<strong>Blog post images:</strong> 1200–1600px wide. Most CMS templates don\'t need more.',
        '<strong>Product photos (e-commerce):</strong> 2000×2000px at most. Shopify and WooCommerce scale down from the source.',
        '<strong>Email images:</strong> 600px wide maximum — most email clients render in a 600px column.',
        '<strong>Social media:</strong> Use the platform presets — each platform has specific optimal dimensions.',
        '<strong>Thumbnails:</strong> 300–500px wide. Anything larger is wasted bytes in a small container.',
      ]},
      { type: 'h2', text: 'Resize vs. Compress: What\'s the Difference?' },
      { type: 'p', html: '<strong>Resizing</strong> changes the pixel dimensions of the image. <strong>Compressing</strong> reduces the file size by removing data within those dimensions. For the smallest possible output, do both: resize to the largest dimension the image will ever be displayed at, then compress. A 4000px image resized to 1200px and then compressed to quality 80 will be dramatically smaller than the original, with no visible quality loss at its displayed size.' },
      { type: 'p', html: 'After resizing, compress the result at <a href="/compress-image" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/compress-image</a>. Both steps run entirely in your browser.' },
    ],
  },
  {
    slug: 'how-to-watermark-a-pdf',
    title: 'How to Add a Watermark to a PDF Online',
    description: 'Adding a text or image watermark to a PDF protects your work, marks drafts as confidential, and identifies document ownership — without any desktop software.',
    date: '2026-05-05',
    category: 'productivity',
    readingTime: 4,
    ...
    body: [
      ...
      { type: 'ol', items: [
        'Go to <a href="/watermark-pdf" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/watermark-pdf</a>',
        'Upload your PDF by dragging it onto the page or clicking to browse',
        'Type your watermark text — "CONFIDENTIAL", "DRAFT", your company name, or any custom text',
        'Adjust the font size, opacity, and position (diagonal centre is the most visible and hardest to crop out)',
        'Click <strong>Apply Watermark</strong> and download the result',
      ]},
      { type: 'callout', kind: 'info', text: 'The watermark is applied to every page of the PDF, not just the first. For a 50-page document, every page gets stamped in a single operation.' },
      { type: 'h2', text: 'Choosing the Right Watermark Opacity' },
      { type: 'p', html: 'Opacity controls the balance between visibility and readability of the underlying content:' },
      { type: 'ul', items: [
        '<strong>20–30% opacity:</strong> Subtle — text is readable, watermark is a background hint. Good for "SAMPLE" marks on content you want recipients to read.',
        '<strong>40–60% opacity:</strong> Balanced — clearly visible without obscuring important content. Good for "CONFIDENTIAL" and "DRAFT" marks.',
        '<strong>70%+:</strong> Bold — dominant watermark that makes content hard to use without authorisation. Good for preview documents you don\'t want reused.',
      ]},
      { type: 'h2', text: 'Common Watermark Use Cases' },
      { type: 'ul', items: [
        '<strong>DRAFT:</strong> Mark working versions sent for review — prevents recipients from treating them as final',
        '<strong>CONFIDENTIAL:</strong> Internal documents shared outside the organisation',
        '<strong>SAMPLE:</strong> Portfolio work or proposals shared with prospects — establishes the deliverable hasn\'t been licensed yet',
        '<strong>Company name or URL:</strong> Ownership mark on publicly distributed PDFs',
        '<strong>DO NOT DISTRIBUTE:</strong> Meeting notes, financial models, or unreleased content sent to limited recipients',
      ]},
      { type: 'h2', text: 'Does a PDF Watermark Prevent Copying?' },
      ...
      { type: 'callout', kind: 'tip', text: 'For documents sent to multiple recipients, include the recipient\'s name or email in the watermark text. This turns every copy into a traceable artefact — if a document leaks, you know exactly which copy it came from.' },
      { type: 'p', html: 'All watermarking happens in your browser — the PDF content never leaves your device. <a href="/watermark-pdf" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">Try the PDF watermark tool</a>.' },
    ],
  },
  {
    slug: 'how-to-convert-heic-to-jpg',
    title: 'How to Convert HEIC Photos to JPEG (A Simple Guide)',
    description: "iPhone photos in HEIC format won't open on Windows or most web platforms. Here's the quickest way to convert them to universally compatible JPEG.",
    date: '2026-05-05',
    category: 'productivity',
    readingTime: 4,
    ...
    body: [
      ...
      { type: 'h2', text: 'Option 1: Change iPhone Camera Settings (Prevent the Problem)' },
      { type: 'p', html: 'To stop your iPhone from shooting HEIC in the first place: <strong>Settings → Camera → Formats → Most Compatible</strong>. This switches to JPEG for all future photos. Already-saved HEIC photos are not affected.' },
      { type: 'h2', text: 'Option 2: Convert Existing HEIC Files to JPEG' },
      { type: 'p', html: 'For HEIC files you already have, the fastest approach is to use an online converter. The challenge is that most online converters upload your photos to a server — fine for holiday snaps, but a concern for anything private.' },
      { type: 'ol', items: [
        'On iPhone: go to <strong>Settings → Photos → Transfer to Mac or PC → Automatic</strong>. This converts to JPEG when you transfer via cable.',
        'On Mac: open the HEIC file in Preview → File → Export → choose JPEG format.',
        'Online converter: drag the HEIC file into a converter tool. Note that most online tools upload your file to their server.',
      ]},
      { type: 'h2', text: 'HEIC vs. JPEG vs. WebP: Which Is Best for Web?' },
      { type: 'table', headers: ['Format', 'Web support', 'File size', 'Best for'], rows: [
      ...
      { type: 'p', html: 'If you\'re converting HEIC for web use, consider converting to WebP instead of JPEG — WebP gives you similar file size savings to HEIC but with near-universal browser support. <a href="/convert-image-to-webp" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">Convert images to WebP here</a> — no upload required.' },
    ],
  },
  {
    slug: '5-ways-to-speed-up-image-workflow',
    title: '5 Ways to Speed Up Your Image Editing Workflow',
    description: 'The right toolset eliminates repetitive steps. Five workflow improvements that cut image prep time from minutes to seconds.',
    date: '2026-05-05',
    category: 'productivity',
    readingTime: 5,
    ...
    body: [
      ...
      { type: 'callout', kind: 'tip', text: 'Set your default export quality to 80 in Lightroom, Photoshop, Figma, or whatever tool you use. You will never notice the difference, but you will notice the smaller file sizes immediately.' },
      { type: 'h2', text: '2. Use Tool Chaining to Avoid Re-uploading' },
      { type: 'p', html: 'Most people\'s image workflow looks like this: compress an image in one tab, download it, then re-upload it to a cropper in another tab, download again, re-upload to a resizer. That\'s three upload/download cycles for a single image.' },
      { type: 'p', html: 'ImagePDF.Tools chains tools so you can pass the output of one operation directly into the next. Compress → then click "Crop this image" → the compressed result opens in the cropper without re-uploading. Crop → resize → strip metadata, all without ever saving an intermediate file.' },
      { type: 'h2', text: '3. Strip Metadata Before Publishing' },
      { type: 'p', html: 'EXIF metadata adds a few kilobytes to every image and exposes information you may not want public — GPS coordinates from where the photo was taken, the device model, timestamps, and software version. Stripping it takes one click and should be the last step before any public upload.' },
      { type: 'p', html: 'Use <a href="/remove-metadata" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/remove-metadata</a> — drag in an image, click Strip, download. Five seconds per image.' },
      { type: 'h2', text: '4. Convert to WebP for Web Images' },
      { type: 'p', html: 'JPEG is still the default for most people, but WebP at quality 75–80 produces files 25–35% smaller than JPEG at quality 80 with comparable visual quality. Browser support is 97%+. If you\'re preparing images for a website, converting to WebP before upload is a free performance improvement.' },
      { type: 'p', html: 'Convert any image to WebP at <a href="/convert-image-to-webp" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/convert-image-to-webp</a>. The conversion happens in your browser — no upload, no server round-trip.' },
      { type: 'h2', text: '5. Resize to Display Size, Not Max Resolution' },
      { type: 'p', html: 'Serving a 4000×3000px image in a 800px-wide blog post is one of the most common and wasteful patterns on the web. The browser downloads the full 4000px image and then shrinks it to 800px — you pay for 5× more pixels than are ever displayed.' },
      { type: 'p', html: 'Before uploading, resize to the largest size the image will actually be displayed at. For a blog post with a 1200px content column, a 1400px wide image is more than sufficient and will load in roughly a quarter of the time.' },
      { type: 'ul', items: [
        '<strong>Blog images:</strong> 1200–1400px wide',
        '<strong>Product photos:</strong> 2000×2000px max (platforms scale thumbnails from this)',
        '<strong>Hero banners:</strong> 1920px wide, cropped to the display ratio',
        '<strong>Email:</strong> 600px wide — email clients don\'t render wider',
      ]},
      { type: 'p', html: 'Resize at <a href="/resize-image" class="text-violet-600 dark:text-violet-400 hover:underline font-medium">imagepdf.tools/resize-image</a>, then compress the result. Both tools run in your browser — no account, no upload.' },
    ],
  },
];
