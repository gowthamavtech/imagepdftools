  ...
  return (
    <main className="flex-1 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* In short box */}
        <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-5 mb-10 bg-gray-50 dark:bg-gray-900/60">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-bold text-gray-700 dark:text-gray-200">In short</span>
          </div>
        ...
        <div className="space-y-10 text-gray-600 dark:text-gray-300 leading-relaxed text-sm">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-800/60 border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left py-2.5 px-4 font-semibold text-gray-500 dark:text-gray-400 w-32">Tool</th>
                    <th className="text-left py-2.5 px-4 font-semibold text-gray-500 dark:text-gray-400">How it handles your images</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  <tr>
                    <td className="py-3 px-4 text-gray-500 dark:text-gray-400">Other apps</td>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-3">
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Account info</strong> — your name and email address (from Clerk sign-in). Used solely for authentication and account identification.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Subscription status</strong> — whether you are on the Free or Pro plan. Stored in Clerk user metadata. No separate database.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Anonymous analytics</strong> — page views to understand which features are used, via Plausible Analytics. No personal identifiers, no cross-site tracking.</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2.5">
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Account info</strong> — to authenticate you, manage your session, and send essential account-related emails (payment receipts, plan changes).</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Subscription status</strong> — to gate Pro features (unlimited files, ZIP export, ad-free). This data is shown back to you in your account page.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Check />
                <span><strong className="text-gray-800 dark:text-gray-100">Analytics</strong> — to understand product usage patterns and improve the app. No personal data is used for this.</span>
              </li>
            </ul>
          </section>
            ...
            <ul className="mt-3 space-y-2.5">
              {[
                ...
                <li key={bold} className="flex items-start gap-2.5">
                  <Cross />
                  <span><strong className="text-gray-800 dark:text-gray-100">{bold}</strong> {rest}</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={title} className="flex items-start gap-3 border border-gray-200 dark:border-gray-700 rounded-xl p-4 bg-white dark:bg-gray-900/40">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={name} className="flex items-start gap-2.5">
                  <Check />
                  <span><strong className="text-gray-800 dark:text-gray-100">{name}</strong> — {detail}</span>
                </li>
              ))}
            </ul>
          </section>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={right} className="flex items-start gap-2.5">
                  <Check />
                  <span><strong className="text-gray-800 dark:text-gray-100">{right}</strong> — {detail}</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2">
              <li className="flex items-start gap-2.5">
                <Check />
                <span><code className="font-mono text-xs bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded">__clerk_*</code> — session cookies required for authentication. Essential; cannot be disabled if you are signed in.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Check />
                <span><code className="font-mono text-xs bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded">googtrans</code> — stores your selected display language for Google Translate. No tracking data.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Cross />
