    ...
    <div className="mt-4 space-y-3">
      ...
      <div>
        ...
        <input
          ...
          className="w-full h-1.5 appearance-none rounded-full bg-slate-300 dark:bg-slate-600 accent-violet-500 cursor-pointer"
        />
      ...
      <div className="flex items-center gap-3 pt-1">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-2 bg-linear-to-r from-violet-600 to-violet-500 hover:from-violet-700 hover:to-violet-600 disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold text-sm px-6 py-2.5 rounded-xl transition-all"
        >
          {isProcessing ? (
            <>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/8 rounded-2xl p-4 space-y-3 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <img
              ...
              className="w-14 h-14 rounded-xl object-cover bg-violet-950/30 ring-1 ring-violet-100 dark:ring-violet-900 shrink-0 cursor-grab active:cursor-grabbing"
              draggable
